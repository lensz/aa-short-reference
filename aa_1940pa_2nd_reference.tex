...
\usepackage[landscape,margin={3.1cm,1cm}]{geometry}
...
\author{corrections to post@simon-lenz.de}
...
\item attacker fires
\item defender fires
\item push attack or retreat?
\end{enumerate}
AAA, Trapos can be taken as casualties. Cargo not.
